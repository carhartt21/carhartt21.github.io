...
\cventryFull{Oct 2019 -- June 2026\newline(expected)}
...
\cventryFull{Oct 2014 -- Sep 2017}
  ...
  {Technische Universit\"at Ilmenau --- Final Grade: 1.4 (very good)}
...
\begin{enumerate}[nosep, leftmargin=1.5em, itemsep=4pt]
  ...
  \item \textbf{Weather-Robust Augmentation (AWARE)} --- Developed a three-pipeline
    ...
    (IEEE Access, 2026, \doilink{10.1109/ACCESS.2026.3699854}).
\end{enumerate}
...
\cvline{SS 2026}{%
  ...
  Unsupervised Domain Adaptation for Adverse Weather Conditions;
  Benchmarking Vision-Language Models for Adverse Weather Scene Understanding}
...
\begin{itemize}[nosep, leftmargin=1.5em, itemsep=3pt]
  ...
  \item \textbf{ACM Multimedia 2026}\\
  ``CoSpeakAR: Proactive In-situ Scaffolding for L2 Spoken Communication via AR``\\
  ``A Mobile Augmented Reality System for Persistent Virtual Human Interaction``\\
  ``MONET: Museum Observatory of Neuro-affective Eye-Tracking``\\
  ``A Natural Confidant: Exploring the Impact of a Virtual Natural Agent on Emotional Responses and Immersion in Conversational VR``
